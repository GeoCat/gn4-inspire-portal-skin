...
(function() {
  ...
  goog.provide('gn_search_inspireportal_directive');

  var module = angular.module('gn_search_inspireportal_directive', []);
  ...
  module.directive('gnInfoList', ['gnMdView',
    function(gnMdView) {
      return {
        restrict: 'A',
        replace: true,
        templateUrl: '../../catalog/views/inspireportal/directives/' +
